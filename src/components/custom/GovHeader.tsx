...
export default function GovHeader() {
  ...
  return (
    <header className="w-full font-sans">
      <div className="bg-zinc-100 dark:bg-zinc-900 text-[10px] md:text-xs py-1 px-4 flex justify-between items-center border-b border-zinc-200 dark:border-zinc-800 text-zinc-600 dark:text-zinc-400">
        ...
        <div className="flex justify-between items-center max-w-7xl mx-auto">
          <div className="flex items-center gap-4 md:gap-6">
            <div className="flex flex-col items-center justify-center">
              <img
                ...
                alt="Gov Emblem"
                className="h-10 md:h-12 w-auto opacity-90 dark:invert transition-all"
              />
            </div>

            <div className="flex items-center">
              <Image src="/logo.png" width={60} height={60} alt="OneKont Logo" className="h-12 md:h-16 w-auto object-contain" />
            </div>

            <div className="flex flex-col border-l-2 border-zinc-300 dark:border-zinc-700 pl-4 h-10 justify-center">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link href="/admin/dashboard">
              <Button className="bg-blue-700 hover:bg-blue-800 text-white text-xs font-bold shadow-md">Dashboard</Button>
            </Link>
          </div>
        </div>
      </div>
