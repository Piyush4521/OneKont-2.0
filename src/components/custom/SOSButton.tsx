  ...
  return (
    ...
    >
      <div className="relative flex items-center justify-center">
        ...
        <motion.button
          className={`relative z-20 flex items-center justify-center w-48 h-48 rounded-full shadow-2xl transition-colors duration-300 border-4 border-white/20 backdrop-blur-sm
        ...
        >
          <div className="flex flex-col items-center text-white pointer-events-none">
            {isActive ? (
              <>
                <ShieldAlert size={48} className="mb-2 animate-bounce" />
